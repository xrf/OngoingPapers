...
MODULE BlockListReMod
  ...
  TYPE :: BlockListRe
     ...
     REAL(DP), ALLOCATABLE :: index2ReIabj(:,:)
     REAL(DP), ALLOCATABLE :: index2ReIbaj(:,:)
     REAL(DP), ALLOCATABLE :: index2ReJabi(:,:)
     REAL(DP), ALLOCATABLE :: index2ReJbai(:,:)
     REAL(DP), ALLOCATABLE :: index2Abij(:,:)
...
CONTAINS
  ...
  SUBROUTINE setupPhBlockList(this)
    ...
    IF (this%basis%nUnoccupied > 0) THEN
       ...
       CALL setupIabjRe2Abij(this)
       CALL setupIbajRe2Abij(this)
       CALL setupJabiRe2Abij(this)
       CALL setupJbaiRe2Abij(this)
...
!          WRITE(*,*) ' '
 ...
 !   WRITE(*,*) ' '
  ...
  SUBROUTINE countBlocksRe(this)
    ...
    this%iabjRe2Abij = IntMatList_(this%nBlocks)
    this%ibajRe2Abij = IntMatList_(this%nBlocks)
    this%jabiRe2Abij = IntMatList_(this%nBlocks)
    this%jbaiRe2Abij = IntMatList_(this%nBlocks)
    this%abij2ReIabj = IntMatList_(this%blocks%nPphhBlocks)
...
!    write(*,*) ' '
  ...
  SUBROUTINE setupIabj2Index(this)
    ...
    ALLOCATE(this%index2ReIabj(indexHpph, 3))
    ALLOCATE(this%index2ReIbaj(indexHpph, 3))
    ALLOCATE(this%index2ReJabi(indexHpph, 3))
    ALLOCATE(this%index2ReJbai(indexHpph, 3))
    this%index2ReIabj = 0
    this%index2ReIbaj = 0
    this%index2ReJabi = 0
    this%index2ReJbai = 0
  ...
  SUBROUTINE setupAbij2Index(this)
    ...
    this%abij2Index = IntMatList_(this%blocks%nPphhBlocks)
    ...
    ALLOCATE(this%index2Abij(indexPphh, 3))
    this%index2Abij = 0
  ...
  !      nPhPairs = phPairs%dim1
  !      nHpPairs = hpPairs%dim1
  !      pphhIndices = IntMatrix2_(nHpPairs, nPhPairs)
  ...
  !      IF (hpph == 'iabj') THEN
  !         this%iabjRe2Abij%list(blockIndex) = pphhIndices
  !      ELSEIF (hpph == 'ibaj') THEN
  !         this%ibajRe2Abij%list(blockIndex) = pphhIndices
  !      ELSEIF (hpph == 'jabi') THEN
  !         this%jabiRe2Abij%list(blockIndex) = pphhIndices
  !      ELSEIF (hpph == 'jbai') THEN
  !         this%jbaiRe2Abij%list(blockIndex) = pphhIndices
  !      ENDIF
  ...
  SUBROUTINE setupIabjRe2abij(this)
    CLASS(BlockListRe), INTENT(INOUT) :: this 
    CLASS(SpBasis), POINTER :: basis
    TYPE(Block1) :: thisHpphBlock, pphhBlock
    TYPE(IntMatrix) :: phPairs, hpPairs
  ...
  END SUBROUTINE setupIabjRe2abij

  SUBROUTINE setupIbajRe2Abij(this)
    CLASS(BlockListRe), INTENT(INOUT) :: this
    CLASS(SpBasis), POINTER :: basis
    TYPE(Block1) :: thisHpphBlock, pphhBlock
    TYPE(IntMatrix) :: phPairs, hpPairs
  ...
  END SUBROUTINE setupIbajRe2Abij


  SUBROUTINE setupJabiRe2Abij(this)
    CLASS(BlockListRe), INTENT(INOUT) :: this
    CLASS(SpBasis), POINTER :: basis
    TYPE(Block1) :: thisHpphBlock, pphhBlock
    TYPE(IntMatrix) :: phPairs, hpPairs
  ...
  END SUBROUTINE setupJabiRe2Abij


  SUBROUTINE setupJbaiRe2Abij(this)
    CLASS(BlockListRe), INTENT(INOUT) :: this 
    CLASS(SpBasis), POINTER :: basis
    TYPE(Block1) :: thisHpphBlock, pphhBlock
    TYPE(IntMatrix) :: phPairs, hpPairs
  ...
  END SUBROUTINE setupJbaiRe2Abij
