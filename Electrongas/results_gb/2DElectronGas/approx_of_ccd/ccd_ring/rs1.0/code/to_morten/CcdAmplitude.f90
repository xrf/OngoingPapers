...
!    write(*,*) 'pphhall=',this%blocks%nPphhBlocksAll
    ...
    !    write(*,*) 'this%intermediates2(15)%matr=',&
    !         this%intermediates2(15)%matr
    ! endif
...
!    write(*,*) '>3'
    DO blockRe=1, this%blocksRe%nBlocksReThis
       ...
       ! if (blockIndex == 75) then
       !    write(*,*) 'tPphhRe=',tPphhRe
       ! endif
...
!      write(*,*) '>8'
  ...
  !     write(*,*) 'nhp=',nHpPairs,',nph=',nPhPairs 
   ...
   !          write(*,*) '>18'
     ...
     !        write(*,*) '>21'
      ...
      !       write(*,*) '>22'
             ...
             ! if (pphhBlockIndex == 15) then
             !    write(*,*) ' '
             !    write(*,*) 'blockRe=',blockRe,',hp=',hp,',ph=',ph 
             !    write(*,*) 'blockIndex=',blockIndex,&
             !         'pphhIndex=',pphhIndex,&
             !         'pphhBlockIndex=',pphhBlockIndex
             !    write(*,*) 'pp=',pp,',hh=',hh
             !    write(*,*) 'd=',diagram4ReIabj(ph, hp)
             ! endif
    ...
    !    write(*,*) 'this%blocks%nPphhBlocksAll=',&
    !         this%blocks%nPphhBlocksAll
    !    write(*,*) 'this%intermediates2(50)%matr=',&
    !         this%intermediates2(50)%matr
    ! endif
  ...
  SUBROUTINE setupT2MatrixRe(this)
    ...
    DO pphhBlock=1, this%blocks%nPphhBlocksThis
       ...
       DO pp=1, nPp
          DO hh=1, nHh
             ...
             ! if (hpphBlockIndex == 20) then 
             !    write(*,*) 'pphhBlock=',pphhBlock,&
             !         ',m=',this%tPphh(pphhBlock)%matr(pp, hh)
             ! endif
    ...
    DO hpphBlockIndex=1, blocksRe%nBlocks
       ...
       !    write(*,*) 't=',tPphhRe(hpphBlockIndex)%matr
       ! endif
       !     Sum the contribution from all processes
       !     and broadcast the result to all processes
       CALL MPI_ALLREDUCE(tPphhRe(hpphBlockIndex)%matr, &
            ...
            MPI_COMM_WORLD, iError)
       ! if (hpphBlockIndex == 20) then 
       !    write(*,*) 'tt=',this%tPphhRe(hpphBlockIndex)%matr
       ! endif
    ENDDO
    
    ! if (this%basisSp%mpiJobs%iAm == 1) then
    !    write(*,*) 'blocksRe%nBlocks=',&
    !         blocksRe%nBlocks
    !    write(*,*) 'this%tPphhRe(20)%matr=',&
    !         this%tPphhRe(20)%matr
    ! endif
