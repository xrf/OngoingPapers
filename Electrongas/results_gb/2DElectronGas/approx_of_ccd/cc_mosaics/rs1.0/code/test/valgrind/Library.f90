...
! 
!     Element-wise matrix-matrix multiplication, similar
!     to the operation .* in Matlab. Both A and B are m*n
!     matrices.
!
SUBROUTINE elementMatmul(A, B, m, n, C)
  USE ConstantsMod
  IMPLICIT NONE
  INTEGER, INTENT(IN) :: m, n
  REAL(DP), INTENT(IN) :: A(m,n), B(m,n)
